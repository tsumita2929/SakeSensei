...
def _resolve_identity(
    ...
    resolved_session = (
        session_id
        or os.getenv("SAKE_AGENT_SESSION_ID")
...
def search_user_preferences(
    ...
    try:
        ...
        def _extract_text(record) -> Optional[str]:
            content = None
...
@tool
def fetch_sake_price(sake_name: str, screenshot_path: Optional[str] = None) -> str:
